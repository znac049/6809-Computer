...
* FUNCTION atol(): defined at atol.c:9
_atol	EQU	*
...
*    -10,U:    2 bytes: endptr: char *: line 11
*     -8,U:    4 bytes: $V00078: long: line 12
*     -4,U:    4 bytes: $V00079: unsigned long: line 12
* Line atol.c:12: function call: strtoul()
	CLRA
	LDB	#$0A		decimal 10 signed
	PSHS	B,A		argument 3 of strtoul(): int
	LEAX	-10,U		variable `endptr', declared at atol.c:11
* optim: optimizePshsOps
	LDD	6,U		variable `nptr', declared at atol.c:9
...
* Useless label L00077 removed
	LEAS	,U
	PULS	U,PC
* END FUNCTION atol(): defined at atol.c:9
funcend_atol	EQU *
funcsize_atol	EQU	funcend_atol-_atol
