...
********************************************
ROMBEG  EQU     $E000           ; ROM START ASSEMBLY ADDRESS
RAMOFS  EQU     -$6900          ; ROM OFFSET TO RAM WORK PAGE
ROMSIZ  EQU     8192            ; ROM SIZE
ROM2OF  EQU     ROMBEG-ROMSIZ   ; START OF EXTENSION ROM
ACIA    EQU     $C000           ; DEFAULT ACIA ADDRESS
PTM     EQU     $C020           ; DEFAULT PTM ADDRESS
